...
CREATE TABLE `epi_dept`  (
  ...
  `status` tinyint NULL DEFAULT 0 COMMENT '状态	0：正常，-1：异常',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '部门机构表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `epi_health_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '健康记录数据表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `epi_motion_info`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '运动记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `epi_student_classes`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `no` int NULL DEFAULT NULL COMMENT '学号',
  `cls_id` int NULL DEFAULT NULL COMMENT '班级,外键，班级表id',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '学生班级表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `epi_task_sand`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '任务发送表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `epi_user_banding`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户账号绑定表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RenrenScheduler', 'DESKTOP-RCJ875E1610699537066', 1610699675696, 15000);
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RenrenScheduler', 'TASK_1', 'DEFAULT', 'TASK_1', 'DEFAULT', NULL, 1610701200000, -1, 5, 'WAITING', 'CRON', 1610619441000, 0, NULL, 2, );
...
-- ----------------------------
INSERT INTO `sys_user_token` VALUES (1, '5a53155415debd78e5e01fb70de13361', '2021-01-15 11:36:36', '2021-01-14 23:36:36');
